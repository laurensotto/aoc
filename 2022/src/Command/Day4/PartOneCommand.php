...
#[AsCommand(name: 'aoc:4:1', description: 'Challenge Day 4 - Part 1')]
class PartOneCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($lines as $line) {
            ...
            $firstIntersection  = array_intersect($firstElfSections, $secondElfSections);
            $secondIntersection = array_intersect($secondElfSections, $firstElfSections);

            if ($firstIntersection === $firstElfSections || $secondIntersection === $secondElfSections) {
                $fullOverlapCount++;
            }
        }
